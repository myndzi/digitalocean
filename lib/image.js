...
module.exports = function (parent, Promise) {
    ...
    parent.prototype.transferImage = function (imgId, regionId) {
        var self = this, img = new Image({ id: imgId });
        return img.transfer(regionId)
        .then(function (res) {
    ...
    Image.prototype.transfer = function (newRegion) {
        ...
        return this.apiRequest('images/?/transfer', {
            region_id: newRegion
        });
    };
