...
module.exports = function (parent, Promise) {
    ...
    parent.prototype.createDroplet = function (args) {
        ...
        return self.apiRequest('droplets/new', {
            name: args.name,
            size_id: args.sizeId,
            ...
            return self.ApiEvent(res.droplet.event_id).then(function () {
                return self.getDroplet(res.droplet.id);
            });
        });
    };
    ...
    Droplet.prototype.reboot = function () {
        var self = this;
        return self.apiRequest('droplets/?/reboot/').then(function (res) {
            return self.ApiEvent(res.event_id);
        });
    };
